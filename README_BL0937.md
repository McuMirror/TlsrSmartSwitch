...
* Attribute 0x0514: _rms_extreme_under_voltage_period_ - период проверки порогов при включении питания до включения реле. Шаг обработки 8 секунд. При значении равному нулю отключено. Единица измерения 1 секунда. По умолчанию 0 секунд - отключено.
